...
public class CoreTestCase {
    ...
    private DesiredCapabilities getAndroidDesiredCapabilities()
    {
        ...
        capabilities.setCapability("avd","Pixel_3_API_27");
        capabilities.setCapability("avdLaunchTimeout","30000");
        capabilities.setCapability("avdReadyTimeout","30000");
        ...
        capabilities.setCapability("app","/home/universe.dart.spb/daermoshin/IdeaProjects/Vita/QAJA_MOBILE/apps/org.wikipedia.apk");
        return capabilities;
    }
